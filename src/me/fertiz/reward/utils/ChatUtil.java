...
public final class ChatUtil {
    ...
    //co to za guwno Xddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
    ...
    public static void sendTitle(Player p, String subtitle) {
        p.sendTitle(fixColor("&8✰ &6NAGRODA &8✰"), fixColor(subtitle)); //co
    }
}
